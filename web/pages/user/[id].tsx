...
const UserPage: NextPage<UserPageProps> = ({}) => {
  ...
  return (
    <main className="profile-page min-h-screen bg-blue-100">
                ...
                <div className="w-full lg:w-4/12 px-4 lg:order-1">
                  <div className="flex justify-center lg:pt-4">
                    ...
                    <div className="mr-4 p-3 text-center">
                      ...
                      <span className="text-sm text-blue-400">Endorsement</span>
                    </div>
              ...
              <div className="mt-10 py-10 border-t border-blue-200 text-center">
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-9/12 px-4">
                    ...
                    >
                      View All Stories By {userData.getUserById.username}
                    </a>
                  </div>
                </div>
              </div>
